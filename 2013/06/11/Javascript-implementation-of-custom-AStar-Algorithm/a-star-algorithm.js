...
(function () {
    ...
    function run(fieldData) {
        ...
        while (iteration < 1000) {
            ...
            var c = _currentCell;
            var neighbours = [
                { row: c.row - 1, col: c.col - 1, G: 14 }, { row: c.row - 1, col: c.col, G: 10 }, { row: c.row - 1, col: c.col + 1, G: 14 },
                { row: c.row, col: c.col - 1, G: 10 }, /*{ row: c.row, col: c.col}, */ { row: c.row, col: c.col + 1, G: 10 },
                { row: c.row + 1, col: c.col - 1, G: 14 }, { row: c.row + 1, col: c.col, G: 10 }, { row: c.row + 1, col: c.col + 1, G: 14 }
            ];
